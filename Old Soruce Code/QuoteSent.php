...
' ;
	...
	$message  = "The following is an order from your website:\n\n";
					...
					$message .= "Delivery : $" . $_POST['delivery'] . "\n";
					$message .= "Total : $" . $_POST['total'] . " (inc delivery) \n";
...
$message  = "Thank you for placing an order with Eliteblindsandshutters.com.au.  Please visit our website at http://www.eliteblindsandshutters.com.au/ again soon.
...
Elite Blinds and Shutters pty ltd.
http://www.eliteblindsandshutters.com.au/
Abn. 16 130 829 417
Ph. 1300 800 118";
...
?>
<div class="page_heading" style="margin-top:10px;"><span>Online Payment</span></div>
...
///if something missing
 	if (!$_POST['hiddenField']){
			//print("<strong>Thank you for your order!</strong> <p><strong>Amount To Pay:  $".$_POST['total'].".</strong></p>");
	}else if ($invoice=="" ||  $month=="" || $year=="" || $_POST['number1']==""  || $_POST['number2']==""  || $_POST['number3']==""  || $_POST['number4']=="" ){
		echo "<div class='box full_width error'>";
	 ...
	 if (checkCreditCard ($cardnumber, $_POST['cardtype'], $ccerror, $ccerrortext)) {
					...
					echo "<div class='box full_width success'>";
...
<script type="text/javascript">
	...
	<div class="clearfix"></div>
	<form action="QuoteSent.php"  method="post" id="contact_form">
	  <input type="hidden"  value="<?Php print($_POST['contact_name']); ?>" name="contact_name"> 
	  <input type="hidden"  value="<?Php print($_POST['total']); ?>" name="total"> 
	  ...
	  <div class="large-12">Amount:<strong>$<?=number_format($_POST['total'],2)?></strong></div>
	  <div class="large-12">Credit Card Name:</div>
	  <div class="large-12"><input type="text" name="invoice" value="<?php print($_POST['invoice']);?>"></div>
	  ...
	  <div class="large-12"><input type="submit" class="button" value="Pay With Credit Card Now" /></div>
	</form>
	  </div>
      </div><!--large7-->
      <div class="large-5 medium-12 small-12 columns">
	<strong>Thank you for your order!</strong> <p><strong>Amount To Pay:  $<?=number_format($_POST['total'],2)?></strong></p>
	...
	<p>If you would prefer not to pay via credit card and instead 
	      be contacted by one of our staff to arrange for payment, just exit this page by <a href="index.html">clicking here</a>.</p>
      </div><!--large5-->
    </div><!--large12-->
